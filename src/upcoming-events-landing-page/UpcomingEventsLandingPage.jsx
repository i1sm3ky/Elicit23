import "./UpcomingEventsLandingPage.css";
...
import poster2 from "../assets/RTE23Posters/ComingSoon.jpeg";

const UpcomingEventsLandingPage = () => {
  return (
...
export default UpcomingEventsLandingPage;
