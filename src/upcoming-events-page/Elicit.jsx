...
import { ElicitEventData } from "../upcoming-events-data/ElicitEventData.js";
    ...
    <>
      <div className="ElicitMainContainer">
        <div className="ElicitDateContainer">
          <a onClick={MoveBackwards} className={elicitDate == 30 ? "ElicitDateChangeButton ElicitDateChangeButonDisabled" : "ElicitDateChangeButton"}>
            {"<"}
          </a>
          ...
          <a onClick={MoveForwards} className={elicitDate == 32 ? "ElicitDateChangeButton ElicitDateChangeButonDisabled" : "ElicitDateChangeButton"}>
            {">"}
          </a>
        </div>
        <div className="ElicitCardsContainer">
          {ElicitEventData[elicitDate].map((Card, index) => (
            <ElicitEventCard {...Card} offset={ElicitEventData[elicitDate].length - index > 5 ? 40 : (ElicitEventData[elicitDate].length - index) * 10} key={`elicitPoster-${index}`} />
          ))}
        </div>
      </div>
    </>
