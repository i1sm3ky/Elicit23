...
import ElicitLogo from "./Elicit.png";
    ...
    <>
      ...
      <div className="container">
        <div className="card">
          <div className="image-box">
            <img className="image" src={ElicitLogo} />
          </div>
      ...
      <div className="container">
        ...
        <div className="card">
          ...
          <div className="content">
            <div className="name">Vidhanshi </div>
          </div>
        </div>
